...
// TODO: opdracht beter uitvoeren:
// Voeg vervolgens een nieuw component "TrownDices" toe die de vijf gegooide dobbelstenen op het scherm toont
// Voeg nog een nieuw component "ScoreTable" toe: de tabel die alle mogelijke scores weergeeft.
const diceAmount = 5;
const diceSize = 6;
const part2Names = [
  "Three Of A Kind",
...
function calculateScores(values) {
  ...
  // TODO: gebruik geen selectors zoals hier onder, maak vul de waarden in de template in door
  // de (reactive) data via v-bind en v-model te binden aan de template elementen
...
<template>
  <div style="margin: auto; width: 400px; text-align: center">
    ...
    <button @click="throwDices()" style="display: block; margin: auto">
      THROW
    </button>
    <div id="dices">
      <div
