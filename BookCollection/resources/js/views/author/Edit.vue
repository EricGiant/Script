...
<template>
    <AuthorForm :author = "authorData" @submit-form = "submitAuthor" v-if = "authorData">
        <template #label><label for = "authorName">AUTHOR NAME</label><br></template>
        <template #button><button @click.prevent = "deleteAuthorFunc">DELETE</button></template>
    </AuthorForm>
</template>